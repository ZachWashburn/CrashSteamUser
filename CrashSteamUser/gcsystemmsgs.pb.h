...
class CCommunity_GetGamePersonalDataEntries_Response : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_continue_text() const;
  inline void clear_continue_text();
  static const int kContinueTextFieldNumber = 4;
  inline const ::std::string& continue_text() const;
  inline void set_continue_text(const ::std::string& value);
  inline void set_continue_text(const char* value);
  inline void set_continue_text(const char* value, size_t size);
  inline ::std::string* mutable_continue_text();
  inline ::std::string* release_continue_text();
  inline void set_allocated_continue_text(::std::string* continue_text);
 ...
 private:
  ...
  inline void set_has_continue_token();
  inline void clear_has_continue_token();
  inline void set_has_continue_text();
  inline void clear_has_continue_text();
...
inline void CCommunity_GetGamePersonalDataEntries_Response::set_has_continue_text() {
  _has_bits_[0] |= 0x00000008u;
}
inline void CCommunity_GetGamePersonalDataEntries_Response::clear_has_continue_text() {
  _has_bits_[0] &= ~0x00000008u;
}
...
inline const ::std::string& CCommunity_GetGamePersonalDataEntries_Response::continue_text() const {
  ...
  return *continue_text_;
}
inline void CCommunity_GetGamePersonalDataEntries_Response::set_continue_text(const ::std::string& value) {
  set_has_continue_text();
  if (continue_text_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    continue_text_ = new ::std::string;
  }
  continue_text_->assign(value);
  // @@protoc_insertion_point(field_set:CCommunity_GetGamePersonalDataEntries_Response.continue_text)
}
inline void CCommunity_GetGamePersonalDataEntries_Response::set_continue_text(const char* value) {
  set_has_continue_text();
  if (continue_text_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    continue_text_ = new ::std::string;
  }
  continue_text_->assign(value);
  // @@protoc_insertion_point(field_set_char:CCommunity_GetGamePersonalDataEntries_Response.continue_text)
}
inline void CCommunity_GetGamePersonalDataEntries_Response::set_continue_text(const char* value, size_t size) {
  set_has_continue_text();
  if (continue_text_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    continue_text_ = new ::std::string;
  }
  continue_text_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:CCommunity_GetGamePersonalDataEntries_Response.continue_text)
}
...
inline ::std::string* CCommunity_GetGamePersonalDataEntries_Response::release_continue_text() {
  ...
  if (continue_text_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    ::std::string* temp = continue_text_;
